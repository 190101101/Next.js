  ...
  return (
    <div className="min-h-[calc(100vh_-_433px)]">
      <div className="flex justify-between items-center md:flex-row flex-col">
          ...
          <div className="max-h-96 overflow-auto w-full">
              <table className="w-full text-sm text-center text-gray-500 min-w-[1000px]">
                ...
                {cart.products.map((product) => 
                    <tr key={Math.random()} className="transition-all bg-secondary border-gray-700 hover:bg-primary" >
        ...
        <div className="bg-secondary h-screen flex flex-col justify-center text-white p-12 md:w-auto w-full   md:text-start !text-center">
