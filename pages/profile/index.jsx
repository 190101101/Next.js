      ...
      <div className='md:w-80 w-100 flex-shrink-0'>
        <div className='relative flex flex-col items-center p-10 border border-b-0'>
          <div className='relative w-[120px] h-[120px]'>
            <Image src="/images/client1.png" alt="" layout="fill" objectFit='cover' className='rounded-full'/>
          </div>
        ...
        <ul className='w-full font-semibold'>
            ...
            <li onClick={handleSignOut} className={`${tabs === 4 && 'bg-primary'} border w-full p-3 cursor-pointer hover:bg-primary list-none hover:text-white transition-all`}>
